...
class $Install extends Component {
  ...
  componentWillUnmount () {
    $Versions._unsubscribe(this);$Ui._unsubscribe(this)
  }

  componentDidMount () {
    $Versions._subscribe(this);$Ui._subscribe(this)
  }
  ...
  render() {
    ...
    }), _createElement($Title, {  }, _array(`Daily Binaries`)), _createElement($SubTitle, {  }, _array(_createElement("p", {}, [`A fresh binary is created and uploaded to S3 when something changes in the master branch.`]), _createElement("p", {}, [`You can download those binaries here:`]), _createElement("ul", {
      className: `install-files`,
      style: {
