...
class $$Page_NotFound extends Enum {
  constructor() {
    super()
...
class $$Page_Examples extends Enum {
  constructor() {
    super()
...
class $$Page_Install extends Enum {
  constructor() {
    super()
...
class $$Page_Roadmap extends Enum {
  constructor() {
    super()
...
class $$Showcase_Item extends Record {}

$$Showcase_Item.mappings = {"description":null,"title":null,"key":null}

$$Showcase_Item.decode = () => { console.warn('Cannot decode this record!') }
...
_program.addRoutes([{
  ...
  try {
     await $Application.setPage(new $$Page_Try())

  _result = await $Stores_Try.init(`/sources/counter.mint`)
  }
  catch (_error) {
  ...
  _result = await $Stores_Try.init(`/sources/drag.mint`)
  }
  catch (_error) {
    if (_error instanceof DoError) {} else {
        console.warn(`Unhandled error in sequence expression:`)
  ...
  _result = await $Stores_Try.init(`/sources/file-handling.mint`)
  }
  catch (_error) {
    if (_error instanceof DoError) {} else {
        console.warn(`Unhandled error in sequence expression:`)
  ...
  handler: (() => {
    $Application.setPage(new $$Page_Examples())
  }),
  mapping: [],
  path: `/examples`
}, {
  ...
  try {
    ...
    await Promise.all([
      (async () => {
     await $Application.setPage(new $$Page_Install())
  })(),

  (async () => {
     await $Stores_Versions.refresh()
  })()
    ])
  ...
  handler: (() => {
    $Application.setPage(new $$Page_Roadmap())
  }),
  mapping: [],
  path: `/roadmap`
}, {
  handler: (() => {
    $Application.setPage(new $$Page_Home())
  }),
  mapping: [],
  path: `/`
}, {
  handler: (() => {
    $Application.setPage(new $$Page_NotFound())
  }),
  mapping: [],
  path: `*`
}])
...
const $Html_Event = new(class extends Module {
  stopPropagation(event) {
    return event.stopPropagation()
  }
})

const $Uid = new(class extends Module {
  generate() {
...
const $Json = new(class extends Module {
  parse(input) {
    return (() => {
          try {
...
const $Html = new(class extends Module {
  empty() {
    return false
  }
})

const $String = new(class extends Module {
  isEmpty(string) {
    return _compare(string, ``)
  }
})

const $Time = new(class extends Module {
  now() {
    return new Date()
  }
})

const $Http = new(class extends Module {
  empty() {
  ...
  get(urlValue) {
    return $Http.url(urlValue, $Http.method(`GET`, $Http.empty()))
  }

  post(urlValue) {
    return $Http.url(urlValue, $Http.method(`POST`, $Http.empty()))
  }
...
const $Array = new(class extends Module {
  first(array) {
    return (() => {
          let first = array[0]
          if (first !== undefined) {
...
const $Maybe = new(class extends Module {
...
const $Icons = new(class extends Module {
  navigation() {
...
const $Version = new(class extends Module {
  empty() {
    return new $$Version({
      date: $Time.now(),
      description: ``,
...
const $AssetLoader = new(class extends Module {
  loadStyle(url) {
    return Assets.loadStyle(url)
  }

  loadScript(url) {
    return Assets.loadScript(url)
  }

  loadAll(method, urls) {
    return Assets.loadAll(method, urls)
  }
})
...
class $Main extends Component {
  ...
  render() {
    return _createElement($Layout, {  }, _array((() => {
      let __condition = this.page

         if (__condition instanceof $$Page_Examples) {
          

          return _createElement($Pages_Examples, {  })
        }   if (__condition instanceof $$Page_NotFound) {
          

          return _createElement($Pages_NotFound, {  })
        }   if (__condition instanceof $$Page_Roadmap) {
          

          return _createElement($Pages_Roadmap, {  })
        }   if (__condition instanceof $$Page_Install) {
          

          return _createElement($Pages_Install, {  })
        }   if (__condition instanceof $$Page_Home) {
          

          return _createElement($Pages_Home, {  })
        }   if (__condition instanceof $$Page_Try) {
...
class $Title extends Component {
  ...
  render() {
    return _createElement("div", {
      className: `title-base_media_0 title-base`
    }, [this.children])
  }
}
...
class $SubTitle extends Component {
  ...
  render() {
    return _createElement("div", {
      className: `sub-title-base_media_0 sub-title-base`
    }, [this.children])
  }
}
...
class $Features extends Component {
  render() {
    return _createElement("div", {
      className: `features-base`
    }, [_createElement("div", {
      className: `features-container`
    }, [_createElement("div", {
      className: `features-title`
    }, [`Why use Mint?`]), _createElement("div", {
      className: `features-subtitle`
    }, [`Because it has a lot of awesome features!`]), _createElement("div", {
      className: `features-grid`
    }, [_createElement($Feature, { "title": `Typed`, "text": `Mint is a typed language. From components to HTML and CSS everything is type checked, which means virtually no runtime exceptions.` }), _createElement($Feature, { "title": `Fast`, "text": `Mint is fast. With incremental compilation it's usually under a half a second to reload the page, while automatically formatting the code.` }), _createElement($Feature, { "title": `Everything is included`, "text": `Mint has a development server, production builder, test runner and formatter in one binary, it has everything you need to create SPAs.` }), _createElement($Feature, { "title": `Built in styling`, "text": `Write scoped CSS directly in components, and stop worrying about conflicting global styles.` }), _createElement($Feature, { "title": `Built in state management`, "text": `With stores you can handle the state of the application easily, when the data changes the view is re-rendered.` }), _createElement($Feature, { "title": `Built in routing`, "text": `Define the routes of your application at the language level and let the runtime handle the navigation for you.` }), _createElement($Feature, { "title": `Immutable`, "text": `Data structures are immutable by default, only stores and the components state is mutable in a safe way.` }), _createElement($Feature, { "title": `Managed computations`, "text": `Handling synchronous and asynchronous computation is easy with the try and do statements.` }), _createElement($Feature, { "title": `Expression oriented`, "text": `Mint is an expression oriented language this means that everything is an expression.` })])])])
  }
}
...
class $Logo extends Component {
  ...
  render() {
    return _createElement("svg", {
      ...
      "height": `256`,
      "width": `256`,
      className: `logo-base_media_0 logo-base`,
      style: {
...
class $Header extends Component {
  ...
  componentDidUpdate () {
    if (true) {
      $Provider_Scroll._subscribe(this, new $$Provider_Scroll_Subscription({
      scrolls: ((event) => {
  ...
  render() {
    return [_createElement("div", {
      ...
      className: `header-desktop_media_0 header-desktop`
    }, [_createElement("a", {
      "href": `/try`,
      ...
      className: `header-mobile_media_0 header-mobile`
...
class $Showcase_Highlight extends Component {
  ...
  handleClick(event) {
    return (async () => {
      ...
      _result = await this.setActive(this.name)
      }
      catch (_error) {
        if (_error instanceof DoError) {} else {
            console.warn(`Unhandled error in sequence expression:`)
  ...
  handleMouseEnter(event) {
    return (async () => {
      ...
      _result = await this.setOver(this.name)
      }
      catch (_error) {
        if (_error instanceof DoError) {} else {
            console.warn(`Unhandled error in sequence expression:`)
  ...
  render() {
    return _createElement("div", {
      "onMouseLeave": (event => (this.handleMouseLeave)(_normalizeEvent(event))),
      "onMouseOver": (event => (this.handleMouseEnter)(_normalizeEvent(event))),
      "onClick": (event => (this.handleClick)(_normalizeEvent(event))),
      className: `showcase_highlight-base`,
      style: {
...
class $Showcase_HighlightBlock extends Component {
  ...
  render() {
    return _createElement("div", {
      ...
      "onMouseOver": (event => (this.handleMouseEnter)(_normalizeEvent(event))),
      "onClick": (event => (this.handleClick)(_normalizeEvent(event))),
      className: `showcase_highlight-block-base_media_0 showcase_highlight-block-base`,
      style: {
      ...
      className: `showcase_highlight-block-content`
    }, [this.children]), this.closingChar])
  }
}
...
class $Github extends Component {
  render() {
    return _createElement("div", {
      className: `github-base_media_0 github-base`
    }, [_createElement("img", {
...
class $Showcase extends Component {
  get data() {
    return [new $$Showcase_Item({
      ...
      title: `Store State`,
      key: `store-state`,
      description: _createElement("ul", {}, [_createElement("li", {}, [`The `, _createElement("code", {}, [`state`]), ` keyword when used in a store defines part of the data that the store contains.`]), _createElement("li", {}, [`The data are available through the `, _createElement("code", {}, [`state`]), ` variable of the store.`])])
    }), new $$Showcase_Item({
      title: `Functions`,
      key: `function`,
  ...
  render() {
    let selected = $Maybe.withDefault(new $$Showcase_Item({
    ...
    return _createElement("div", {
      ...
      className: `showcase-base_media_0 showcase-base`
    }, [_createElement("div", {
      className: `showcase-title`
    }, [`Explore an example`]), _createElement("div", {
      className: `showcase-hint`
    }, [`Click on the parts to learn more.`]), _createElement("div", {
      className: `showcase-wrapper_media_0 showcase-wrapper`
    }, [_createElement("pre", {
      className: `showcase-code_media_0 showcase-code`
    }, [_createElement($Showcase_HighlightBlock, { "line": `store Counter.Store`, "padding": `5px 10px`, "name": `store` }, _array(_createElement($Showcase_Highlight, { "text": `state counter : Number = 0`, "name": `store-state` }), _createElement("div", {
      className: `showcase-spacer`
    }), _createElement($Showcase_HighlightBlock, { "line": `fun increment : Promise(Never, Void)`, "name": `function` }, _array(_createElement($Showcase_Highlight, { "text": `next { counter = counter + 1 }`, "name": `next` }))), _createElement("div", {
      className: `showcase-spacer`
    }), _createElement($Showcase_Block, { "line": `fun decrement : Promise(Never, Void)` }, _array(`next { counter = counter - 1 }`)))), _createElement("div", {
      className: `showcase-spacer`
      ...
      className: `showcase-spacer`
    }), _createElement($Showcase_Block, { "line": `fun handleIncrement (event : Html.Event) : Promise(Never, Void)` }, _array(`increment()`)), _createElement("div", {
      className: `showcase-spacer`
    }), _createElement($Showcase_Block, { "line": `fun handleDecrement (event : Html.Event) : Promise(Never, Void)` }, _array(`decrement()`)), _createElement("div", {
      className: `showcase-spacer`
    }), _createElement($Showcase_HighlightBlock, { "line": `fun render : Html`, "name": `render` }, _array(_createElement($Showcase_Block, { "closingChar": `</div>`, "openingChar": ``, "line": `<div::base>` }, _array(_createElement($Showcase_HighlightBlock, { "closingChar": `</button>`, "openingChar": ``, "line": `<button`, "name": `html-element` }, _array(_createElement($Showcase_Highlight, { "text": `onClick={handleDecrement}`, "name": `event` }), `\ndisabled={disabled}>`, _createElement("div", {
      className: `showcase-spacer`
      ...
      className: `showcase-description_media_0 showcase-description`
    }, [_createElement("div", {
      className: `showcase-section-title_media_0 showcase-section-title`
...
class $Page extends Component {
  ...
  render() {
    return _createElement("div", {
      className: `page-base_media_0 page-base`
    }, [this.children])
  }
}
...
class $Pages_Try extends Component {
  ...
  render() {
    return _createElement("div", {
      className: `pages_try-base`
    }, [_createElement("div", {
      className: `pages_try-source_media_0 pages_try-source`
    }, [_createElement("div", {
      className: `pages_try-toolbar`
    }, [_createElement("div", {
      className: `pages_try-file`
    }, [`Main.mint`]), _createElement("button", {
      "onClick": (event => (this.handleCompile)(_normalizeEvent(event))),
      className: `pages_try-button`
    }, [`Compile`])]), _createElement("div", {
      className: `pages_try-editor`
    }, [_createElement($CodeMirror, { "javascripts": [`/codemirror.min.js`], "styles": [`/codemirror.min.css`, `/codemirror.neo.min.css`], "onChange": this.handleChange, "value": this.source, "theme": `neo` })])]), this.frame])
  }
}
...
class $Pages_NotFound extends Component {
  render() {
    return _createElement($Page, {  }, _array(_createElement("div", {
      className: `pages_not-found-base`
    }, [_createElement("div", {
      className: `pages_not-found-title`
    }, [`404`]), _createElement("div", {
      className: `pages_not-found-text`
...
class $Pages_Install extends Component {
  ...
  get files() {
    return (this.loading ? [] : (() => {
      const _0 = []
      const _1 = this.latest.assets

      for (let asset of _1) {
        _0.push(_createElement("li", {}, [_createElement("a", {
      "href": asset.url,
  ...
  render() {
    return _createElement($Page, {  }, _array(_createElement($Title, {  }, _array(`Install Binaries`)), _createElement($SubTitle, {  }, _array(`Follow the directions below to install Mint:`)), _createElement("ol", {
      ...
      className: `pages_install-hint_media_0 pages_install-hint`
    }, [_createElement("svg", {
      "xmlns": `http://www.w3.org/2000/svg`,
      "preserveAspectRatio": `xMidYMid meet`,
      "viewBox": `0 0 24 24`,
      className: `pages_install-hint-icon_media_0 pages_install-hint-icon`
...
class $Pages_Examples extends Component {
  render() {
    return _createElement($Page, {  }, _array(_createElement($Title, {  }, _array(`Examples`)), _createElement($SubTitle, {  }, _array(`Here you can find some examples that showcase the language's features.`)), _createElement("hr", {
      className: `pages_examples-hr`
    }), _createElement("div", {
      className: `pages_examples-grid`
...
class $Pages_Examples_Example extends Component {
  ...
  render() {
    return _createElement("a", {
      "href": this.href,
      className: `pages_examples_example-base`
    }, [_createElement("div", {
      className: `pages_examples_example-title`
    }, [this.title]), _createElement("div", {
      className: `pages_examples_example-description`
    }, [this.description])])
  }
}
...
class $Pages_Roadmap_Version extends Component {
  ...
  render() {
    return _createElement("div", {}, [_createElement("div", {
      className: `pages_roadmap_version-name`
    }, [this.name]), _createElement("div", {
      className: `pages_roadmap_version-features`
    }, [this.children])])
  }
}
...
class $Pages_Roadmap_Feature extends Component {
  ...
  render() {
    return _createElement("div", {
      className: `pages_roadmap_feature-base`
    }, [_createElement("div", {
      className: `pages_roadmap_feature-icon_media_0 pages_roadmap_feature-icon`
    }, [this.icon]), _createElement("div", {}, [_createElement("div", {
      className: `pages_roadmap_feature-title`
    }, [this.name]), _createElement("div", {
      className: `pages_roadmap_feature-description`
    }, [this.description]), _createElement($Unless, { "condition": $Array.isEmpty(this.children) }, _array(_createElement("div", {
      className: `pages_roadmap_feature-features_media_0 pages_roadmap_feature-features`
    }, [this.children])))])])
  }
}
...
class $CodeMirror extends Component {
  get display() {
    return (this.editor ? `` : `none`)
  }

  get javascripts () {
    if (this.props.javascripts != undefined) {
      return this.props.javascripts
    } else {
      return [`https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.39.0/codemirror.min.js`]
    }
  }
  ...
  get styles () {
    if (this.props.styles != undefined) {
      ...
      return [`https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.39.0/codemirror.min.css`]
    }
  }
  ...
  get loadingContent () {
    if (this.props.loadingContent != undefined) {
      return this.props.loadingContent
    } else {
      return _createElement(React.Fragment, {}, [])
    }
  }

  get lineNumbers () {
    if (this.props.lineNumbers != undefined) {
  ...
  componentDidMount() {
    return (async () => {
      ...
      try {
         await $AssetLoader.loadAll($AssetLoader.loadScript, this.javascripts)

       await $AssetLoader.loadAll($AssetLoader.loadStyle, this.styles)

      _result = await this.initializeEditor()
      }
      catch (_error) {
        if (_error instanceof DoError) {} else {
            console.warn(`Unhandled error in sequence expression:`)
  ...
  render() {
    return [_createElement("textarea", {
      className: `code-mirror-editor`,
      style: {
        [`--code-mirror-editor-display`]: this.display
      },
      ref: (element) => { this._element = element }
    }), (this.editor ? _createElement(React.Fragment, {}, []) : this.loadingContent)]
  }
}
...
const $Stores_Try = new (class extends Store {
  ...
  get compiling() { return this.state.compiling }
  ...
  init(url) {
    return $Stores_Try.loadSource(url)
  }
  ...
  loadSource(url) {
    return (async () => {
      ...
      error: `Could not load souce file!`
      })), _resolve)
      })
      ...
      throw new DoError()
       ...
       await $Stores_Try.setSource(response.body)

      _result = await $Stores_Try.compile()
      }
      catch (_error) {
        if (_error instanceof DoError) {} else {
            console.warn(`Unhandled error in sequence expression:`)
  ...
  html(url) {
    return `<html><body><script src="` + url + `"></script></body></html>`
  }
  ...
  compile() {
    return (async () => {
      ...
      _result = await (_compare(response.status, 500) ? new Promise((_resolve) => {
        this.setState(_update(this.state, new Record({
      src: $Stores_Try.createObjectUrl(response.body, `text/html`)
      })), _resolve)
      }) : (async () => {
        let _result = null;

        try {
          let url = await $Stores_Try.createObjectUrl(response.body, `application/javascript`)

        let newSrc = await $Stores_Try.createObjectUrl($Stores_Try.html(url), `text/html`)
...
const $Stores_Versions = new (class extends Store {
  ...
  get errored() { return this.state.errored }
  ...
  refresh() {
    return (this.initialized ? $Promise.never() : $Stores_Versions.load())
  }
  ...
  load() {
    return (async () => {
      ...
      let response = await $Http.send($Http.get(`https://mint-website.herokuapp.com/releases`))
      ...
      let _3 = Decoder.array($$Version.decode)(object)

      if (_3 instanceof Err) {
        throw _3.value
      }

      let newVersions = _3.value
...
_insertStyles(`
  ...
  .showcase_block-content {
    padding-left: 20px;
  }

  .showcase_highlight-block-base {
    -webkit-tap-highlight-color: rgba(0,0,0,0);
  ...
  .showcase_highlight-block-content {
    padding-left: 15px;
  }
  ...
  .pages_not-found-title {
    font-family: Josefin Sans;
    font-size: 100px;
  }

  .pages_not-found-text {
    margin-bottom: 40px;
    font-size: 20px;
  }

  .pages_not-found-base {
    justify-content: center;
    flex-direction: column;
    align-items: center;
    display: flex;
  ...
  .pages_install-hint > a {
    margin: 0 5px;
  }

  .pages_install-hint-icon {
    margin-right: 15px;
    flex: 0 0 24px;
    fill: #00ccff;
    height: 24px;
  ...
  .pages_examples_example-description {
    line-height: 1.5;
    font-size: 14px;
  }

  .pages_examples_example-title {
  ...
  .pages_examples_example-title > a {
    color: inherit;
  }
  ...
  .pages_roadmap_version-features {
  ...
  .pages_roadmap_feature-base {
    display: flex;
  }

  .pages_roadmap_feature-icon {
    margin-right: 10px;
    opacity: 0.3;
  }

  .pages_roadmap_feature-icon:empty {
    display: none;
  }

  .pages_roadmap_feature-icon > svg {
    height: 12px;
    width: 12px;
  }

  .pages_roadmap_feature-title {
    font-weight: 600;
    color: #222;
  }

  .pages_roadmap_feature-description {
    font-size: 14px;
    color: #777;
  }

  .pages_roadmap_feature-features {
  ...
  .code-mirror-editor {
    display: var(--code-mirror-editor-display);
  }  @media (max-width: 600px)  {
    .title-base_media_0 {
      font-size: 24px;
    }

    .sub-title-base_media_0 {
      font-size: 14px;
    }
    ...
    .showcase_highlight-block-base_media_0 {
      white-space: pre-wrap;
    }
    ...
    .showcase-base_media_0 {
      padding-bottom: 20px;
    }

    .showcase-code_media_0 {
      margin-bottom: 20px;
    }

    .showcase-description_media_0 {
    ...
    .showcase-wrapper_media_0 {
      font-size: 12px;
      display: block;
    }

    .showcase-section-title_media_0 {
      font-size: 18px;
    }
    ...
    .pages_try-source_media_0 {
      display: none;
    }

    .pages_install-code_media_0 {
      padding: 3px 5px;
    }

    .pages_install-list_media_0 {
      padding-left: 15px;
      font-size: 14px;
    }

    .pages_install-hint_media_0 {
      display: block;
    }

    .pages_install-hint-icon_media_0 {
      display: none;
    }

    .pages_home-hero_media_0 {
      padding: 50px 20px;
      height: auto;
    }

    .pages_home-slogan_media_0 {
      margin-top: 10px;
      font-size: 13px;
    }

    .pages_home-buttons_media_0 {
      flex-direction: column;
    }

    .pages_home-separator_media_1 {
      margin-top: 15px;
    }

    .pages_roadmap_feature-icon_media_0 {
      display: none;
    }

    .pages_roadmap_feature-features_media_0 {
      margin-left: 3px;
    }}
  ...
  @media (min-width: 600px)  {
    .header-desktop_media_0 {
      display: flex;
    }

    .pages_home-separator_media_0 {
      margin-left: 30px;
    }}

  @media (max-width: 599px)  {
    .header-mobile_media_0 {
      display: block;
    }}
`)
